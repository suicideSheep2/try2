document.addEventListener('DOMContentLoaded', function() {
    ...
    function openModal(index) {
      ...
      downloadButton.setAttribute('data-url', imageFile.download_url);
      downloadButton.setAttribute('data-filename', imageFile.name);
  
      imageInfo.textContent = `${imageFile.name} • ${state.currentIndex + 1} of ${state.currentImages.length}`;
    ...
    function updateModalImage() {
      ...
      // Update download button attributes when navigating
      downloadButton.setAttribute('data-url', imageFile.download_url);
      downloadButton.setAttribute('data-filename', imageFile.name);
